...
data1 = readtable('Site 4.csv'); % Replace 'Site_5.csv' with your actual file name
...
monopoly_amount_site5 = 25000000 / area_monopoly;
thin_amount_site5 = 25000000 / area_thin;
