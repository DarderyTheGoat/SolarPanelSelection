...
data1 = readtable('Site 2 (1).csv'); % Replace 'Site_5.csv' with your actual file name
...
monopoly_amount_site5 = 9000000 / area_monopoly;
thin_amount_site5 = 9000000 / area_thin;
